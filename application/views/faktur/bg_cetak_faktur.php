...
<div id="container">
	<h1>CV. BINTANG ATRA SARANA KOMPUTER - FAKTUR PENJUALAN</h1>
	...
	<div id="body">
		<div id="body">
			<table width="100%" cellpadding="3" cellspacing="0">
				...
				<input type="text" value="<?php echo gmdate('d/m/Y H:i:s',$tanggal_faktur); ?>" class="input-read-only" readonly="true" 
