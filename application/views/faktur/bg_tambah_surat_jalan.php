...
<div id="container">
	<h1>CV. BINTANG ATRA SARANA KOMPUTER - SURAT JALAN</h1>
	<h2>Jl. Krasak No 48, Kotabaru, Yogyakarta</h2>

	<div id="body">
		<div id="body">
		<?php echo form_open('faktur/simpan_surat_jalan', 'name="frm"'); ?>
			<table width="100%" cellpadding="3" cellspacing="0">
				...
				"input-read-only" readonly="true" style="width:280px;" name="kode_faktur" /></td>
				...
				<input type="text" value="<?php echo $alamat_pelanggan; ?>" class="input-read-only" readonly="true" 
				 style="width:280px;" name="alamat_pelanggan" /></td></tr>
			</table>
		...
		<?php endforeach; ?>
			...
			<div class="cleaner_h10"></div>
			<input type="submit" class="btn-kirim-login" value="Simpan Dan Cetak Surat Jalan">
		<?php echo form_close(); ?>
		</div>
	</div>