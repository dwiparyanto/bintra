...
<div id="container">
	...
	<h6><?php echo $jdl; ?> Data - Pemesanan</h6>
		...
		<?php $atr = array('name' => 'frm', 'id' => 'frm'); echo form_open('pemesanan/simpan_pesanan',$atr); ?>
		<input type="hidden" name="stts_order" value="Pending" />
			<div class="cleaner_h10"></div>
			<input type="submit" class="btn-kirim-login" value="Simpan Data Pesanan">
