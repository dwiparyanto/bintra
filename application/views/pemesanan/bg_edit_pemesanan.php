...
<div id="container">
	...
	<h6><?php echo $jdl; ?> Data - Pemesanan</h6>
		<div id="body">
		...
		<h3>Data Pesanan</h3>
			<?php echo form_open('pemesanan/update_pesanan'); ?>
			...
			<tr style="background-color:#333; color:#FFFFFF;" align="center">
				...
				<td width="140">Terkirim | Status Barang</td>
			...
			<?php $sisa_pending=0; echo form_hidden('rowid[]', $items['rowid']); ?>
			<tr class="content">
				...
				<select name="qty[]" class="input-read-only" style="width:50px;">
					<?php 
				...
				<?php foreach ($this->cart->product_options($items['rowid']) as $option_name => $option_value)
				{
					switch ($option_name) {
						case "SttsPengiriman":
							...
							{
							?>
							<input type="checkbox" disabled="true" value="terkirim" name="stts_pengiriman[]" checked="checked" />Terkirim
							<?php
							}
							else
							{
							?>
							<input type="checkbox" disabled="true" value="terkirim" name="stts_pengiriman[]" />Terkirim
							<?php
							}
							break;
						case "QtyTerkirim":
						$sisa_pending=$option_value;
							?>
							<select name="qty_terkirim[]" class="input-read-only" style="width:50px;">
								<?php
				...
				<td class="td-keranjang"><?php echo $items['qty']-$sisa_pending; ?></td>
		...
		<?php $atr = array('name' => 'frm', 'id' => 'frm', 'onSubmit' => $alert); echo form_open('pemesanan/update_pemesanan',$atr); ?>
